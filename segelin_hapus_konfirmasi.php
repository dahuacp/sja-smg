...
?>
                  ...
                  <div class="x_content">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txt_SG_DATE" name="txt_SG_DATE" class="form-control col-md-7 col-xs-12" value="<?php echo $d_PE_Date_TPB;?>" disabled>
                        </div>
                      </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txt_SG_JML" name="txt_SG_JML" class="form-control col-md-7 col-xs-12" value="<?php echo $d_SG_JML;?>" disabled>
                        </div>
                      </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="txt_Bale" name="txt_Bale" class="form-control col-md-7 col-xs-12" value="<?php echo $d_SG_BL;?>" disabled>
                        </div>
                      </div>
            <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">IW (KG)</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="txt_Iw" name="txt_Iw" class="form-control col-md-7 col-xs-12" value="<?php echo $d_SG_KG;?>" disabled>
                        </div>
                      </div>
            <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Voyage</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="txt_Voyage" name="txt_Voyage" class="form-control col-md-7 col-xs-12" value="<?php echo $d_SG_VOYAGE;?>" disabled>
                        </div>
                      </div>
